      ...
      <div className="detail w-1/2 h-full flex flex-col gap-4 justify-center px-5">
        ...
        <div className="cart flex items-center my-4">
          <div className="btns flex">
            <button className='px-4 py-2 border border-gray-400 border-r-0 '>-</button>
            <input type="text"  value={1} className='px-4 py-2 border border-gray-400  w-[15%]'/>
            <button className='px-4 py-2 border border-gray-400 border-l-0 '>+</button>
          </div>
          <button className='px-4 py-2 bg-yellow-800  shadow-lg text-white font-header font-semibold'>Add To Cart</button>
        </div>

  ...
  return (
    <div className='w-4/5 h-28 my-3 flex shadow-lg items-center'>
      ...
      <div className="btns flex h-fit  w-[22.5%]">
        ...
        <input type="text" value={1} className='w-[20%] text-center px-2 py-2 border border-gray-400'/>
        <button className='px-4 py-2 border border-gray-400 border-l-0 '>+</button>
      </div>
      <div className="w-fit h-fit mr-20">
        <h2 className='text-xl font-bold font-header'>₹ {value.food_item.food_price}</h2>
      </div>

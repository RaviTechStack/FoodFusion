...
const CategoryCard = ({val}) => {
  ...
  return (
    <div className={` relative  w-[80vw] md:w-60 h-72 shadow-sm  rounded-lg my-2 bg-no-repeat bg-cover hover:scale-110 transition-transform delay-100 bg-center flex flex-col justify-end`}
